///
/// HybridFMLanguageModelSessionSpecSwift.hpp
...
namespace margelo::nitro::rnappleai {
  ...
  /**
   * The C++ part of HybridFMLanguageModelSessionSpec_cxx.swift.
   *
   * HybridFMLanguageModelSessionSpecSwift (C++) accesses HybridFMLanguageModelSessionSpec_cxx (Swift), and might
   * contain some additional bridging code for C++ <> Swift interop.
   *
   * Since this obviously introduces an overhead, I hope at some point in
   * the future, HybridFMLanguageModelSessionSpec_cxx can directly inherit from the C++ class HybridFMLanguageModelSessionSpec
