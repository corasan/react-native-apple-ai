///
/// HybridFoundationModelsSpec_cxx.swift
...
/**
 * A class implementation that bridges HybridFoundationModelsSpec over to C++.
...
public class HybridFoundationModelsSpec_cxx {
   ...
   * from `FoundationModels-Swift-Cxx-Bridge.hpp`.
   ...
   */
  private var __implementation: any HybridFoundationModelsSpec
   ...
   */
  public init(_ implementation: any HybridFoundationModelsSpec) {
  ...
  /**
   * Get the actual `HybridFoundationModelsSpec` instance this class wraps.
   */
  @inline(__always)
  public func getHybridFoundationModelsSpec() -> any HybridFoundationModelsSpec {
  ...
  /**
   * Casts an unsafe pointer to a `HybridFoundationModelsSpec_cxx`.
   * The pointer has to be a retained opaque `Unmanaged<HybridFoundationModelsSpec_cxx>`.
   * This removes one strong reference from the object!
   */
  public class func fromUnsafe(_ pointer: UnsafeMutableRawPointer) -> HybridFoundationModelsSpec_cxx {
    return Unmanaged<HybridFoundationModelsSpec_cxx>.fromOpaque(pointer).takeRetainedValue()
  }
